...
TEST(Poly, can_construct_from_string)
{
	...
	ASSERT_NO_THROW(Polinom p("10*x^5*y^1*z^4+7*x^4*y^2*z^1+12*x^3+7*z^2+7-13*x^7*y^1*z^3", var, 20));
}
...
TEST(Poly, mult_gives_correct_answer)
{
	...
	Polinom res("-96*a^4-108*a^2*b^3-52*a^2+24*a^2*b*c+27*b^4*c+21*b*c+36*b^3+28", var, 20);
